...
<html lang="en">
  ...
  <body>
    ...
    <?php 
      ...
      $errors = array();
      if( isset($_POST["nom"])  And isset($_POST["prenom"])   And isset($_POST["statut"]) And isset($_POST["montant"]) And isset($_POST["duree"]) And isset($_POST["naissance"]) And isset($_POST["salaire"]) And isset($_POST["montant total"]) ){
        $nom = $_POST['nom'];
        $prenom = $_POST['prenom'];
        $statut = $_POST['statut'];
